...
5. **코드 흐름도 §11**: 개념도가 실제 코드로 어떻게 도는지
6. **실험 §12**: 속도/메모리 숫자
7. **Q&A §13**: 대화에서 나온 질문들 (학습·FLUX.2 적용 등)
...
![PiD 전체 구조 (Figure 3)](images/PiD_fig3.png)
...
### 11.2 PiD 샘플러 — 4-step student loop
