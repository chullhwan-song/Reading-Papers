...
| 4 | Multi-step generator | 1-step의 어려움을 4-step으로 나누어 해결 |
...
## 10. 해결책 4: Multi-step generator - 4번에 나누어 만들기

1-step 생성은 빠르지만 너무 어려운 문제입니다.
...
| multi-step 지원 | 제한적 | consistency-style 4-step |
